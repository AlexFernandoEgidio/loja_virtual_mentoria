...
public class TesteAPIMelhorEnvio {
	...
	public static void main(String[] args) throws Exception {
		       ...
		       OkHttpClient client = new OkHttpClient().newBuilder() .build(); /*Instancia o objto de requisicao*/
				MediaType mediaType = MediaType.parse("application/json"); /*Tipo do dados em JSON*/
